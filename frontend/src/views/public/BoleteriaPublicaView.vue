    ...
    <header class="border-b border-white/10 bg-white/5 backdrop-blur-xl">
      <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <RouterLink to="/" class="flex items-center gap-3">
          ...
          <span class="text-lg font-bold text-white">Terminal El Dorado</span>
        </RouterLink>
        <nav class="flex items-center gap-4">
          <RouterLink to="/" class="text-sm text-white/70 hover:text-white transition-colors">Inicio</RouterLink>
          <RouterLink to="/registro" class="text-sm text-white/70 hover:text-white transition-colors">Registro</RouterLink>
          <RouterLink to="/rastrear" class="text-sm text-white/70 hover:text-white transition-colors">Rastrear</RouterLink>
        </nav>
      </div>
    </header>
